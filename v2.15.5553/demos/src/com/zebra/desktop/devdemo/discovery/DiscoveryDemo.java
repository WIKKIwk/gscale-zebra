...
public class DiscoveryDemo extends DemoDialog {
    ...
    private static final String IPV6_MULTICAST_BROADCAST = "IPV6 Multicast Broadcast";
    ...
    public DiscoveryDemo(JFrame owner) {
        ...
        discoveryMethodCombo = new JComboBox(new String[] {IPV6_MULTICAST_BROADCAST, LOCAL_BROADCAST, DIRECTED_BROADCAST, MULTICAST_BROADCAST, SUBNET_SEARCH, USB_DRIVER_SEARCH, USB_DIRECT_SEARCH,
                PRINTERS_NEAR_ME });
        ...
        JPanel ipv6MulticastCard = createIpv6MulticastCard();
        ...
        cardPanel.add(ipv6MulticastCard, IPV6_MULTICAST_BROADCAST);
    ...
    private JPanel createSubnetCard() {
        ...
        private JPanel createIpv6MulticastCard() {
        ...
        discoverButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                try {
                    NetworkDiscoverer.ipv6Multicast(new DiscoveryHandlerImpl(discoverButton), numberOfHops);
        ...
        JScrollPane ipv6MulticastCard = new JScrollPane(masterPanel);
        ipv6MulticastCard.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED);
        return masterPanel;
    }
