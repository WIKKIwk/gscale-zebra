...
public class ConnectionBuilderDemo extends DemoDialog {
    ...
    public ConnectionBuilderDemo(JFrame owner) {
        ...
        connectionBuilderPrefixCombo = new JComboBox(new String[] { "", "TCP_MULTI", "TCP", "TCP_STATUS", "TLS_MULTI", "TLS", "TLS_STATUS", "REMOTE_MULTI", "REMOTE", "REMOTE_STATUS", "USB_DIRECT" });
        ...
        try {
            ...
            if (isAttemptingStatusConnection()) {
                ...
                if (printer != null) {
                    ...
                    publishProgress("Printer readiness status not available.");
                }
            } else {
                ...
                if (printer != null) {
                    ...
                    publishProgress("Printer not created — unable to print config label");
