                    ...
                    public void run() {
                        ...
                        if (profilePath.length() > 0) {
                            ...
                            if (file.exists()) {
                                ...
                                DemoDialog.showErrorDialog(ProfileDemo.this, "The file doesn't exist at the specified path.", "File not found");
                                setButtonState(uploadButton, true);
                            }
                        } else {
                            DemoDialog.showErrorDialog(ProfileDemo.this, "Please choose profile path", "Invalid path");
                            setButtonState(uploadButton, true);
                        }
        ...
        if (connection != null)
            try {
                ...
                if (printer != null) {
                    ...
                    JOptionPane.showMessageDialog(ProfileDemo.this, "Profile loaded successfully to printer " + printer.toString(), "Profile Loaded Successfully", JOptionPane.INFORMATION_MESSAGE);
                } else {
